...
public class AppConstants {        
    ...
    public static final String PAGE_CLIENT = "/client_response.jsp";
    ...
    public static final String CLIENT_RESPONSE_LOGIN_FILE_WRITER = "client_response_login.txt";
    public static final String CLIENT_RESPONSE_SEARCH_CASE_FILE_WRITER = "client_response_search_case.txt";
    public static final String CLIENT_RESPONSE_SEARCH_ENC_FILE_WRITER = "client_response_search_enc.txt";
    public static final String CLIENT_RESPONSE_RETRIEVE_ENC_FILE_WRITER = "client_response_retrieve_enc.txt";
    public static final String CLIENT_RESPONSE_SEARCH_ID_FILE_WRITER = "client_response_search_id.txt";
    public static final String CLIENT_RESPONSE_RETRIEVE_PAT_FILE_WRITER = "client_response_retrieve_pat.txt";
    public static final String CLIENT_RESPONSE_INVOICE_PRINT_FILE_WRITER = "client_response_invoice_print.txt";
    
    public static final String WKF_TOP_20_FILE_WRITER = "wkf_top_20.txt";
    public static final String WKF_QUEUE_BY_DTM_FILE_WRITER = "wkf_queue_by_dtm.txt";
    public static final String WKF_QUEUE_BY_CATEGORY_FILE_WRITER = "wkf_queue_by_category.txt";
    ...
    public static final String ALERT_CLASS_SUCCESS = "alert-success";
    public static final String ALERT_CLASS_INFO = "alert-info";
    public static final String ALERT_CLASS_WARNING = "alert-warning";
    public static final String ALERT_CLASS_DANGER = "alert-danger";
    
    public static final String EMAIL_SMTP = "MAILDEVSMTP";
    public static final String EMAIL_FROM_ADD = "hoitpbrcs@pyn.ha.org.hk";
    public static final String EMAIL_FROM_NAME = "HO IT&HI PBRC Support";
    public static final String EMAIL_HEADER = "<head>\n" + 
          ...
          "		.alert{padding:8px 35px 8px 14px;margin-bottom:20px;text-shadow:0 1px 0 rgba(255,255,255,0.5);border:1px solid #fbeed5;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;}\n" + 
          "		.alert h4{margin:0}\n" + 
